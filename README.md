...
Soy **Técnico Superior en Computación y Redes** egresado del **IES Concepción**. Mi pasión por la tecnología comenzó a los 14 años desarrollando mods y plugins para **Minecraft**, lo que me dio una base sólida en Java y lógica de sistemas.

Hoy en día, combino mi conocimiento en **Infraestructura y Redes** con el desarrollo **Full Stack** para crear soluciones escalables, seguras y eficientes.

- 🎂 **Edad:** 24 años (nacido el 21/08/2001).
- 📍 **Ubicación:** Concepción, Tucumán, Argentina.
- ⚡ **Enfoque actual:** Dominando **FastAPI** y profundizando en **React Native**.
- 🛠️ **Pasión extra:** Domotización y virtualización con **Proxmox**.
...
![Networks](https://img.shields.io/badge/Networking-Infrastructure-blue?style=for-the-badge&logo=cisco)

---

## 🎓 Formación & Certificaciones

- 🏛️ **Tecnicatura Superior en Computación y Redes** - IES Concepción.
- 💻 **Argentina Programa** - Especialización Full Stack.
- 🎨 **Diseño Gráfico & Marketing Digital** - Formación complementaria para UI/UX.
- 🛡️ **Cybersecurity & Testing** - Conocimientos en entornos seguros.
